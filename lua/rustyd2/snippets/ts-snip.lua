...
ls.add_snippets("typescript", {
	s("pro", t("const promises :Promise<unknown>[] = [];")),
})
...
ls.add_snippets("typescript", {
	s(
		"thr",
		c(1, {
			fmta([[throw new AppError('<functionName>: <key>');]], { key = i(1), functionName = i(2) }),
			fmta(
				[[if(! <key1> ) throw new AppError('<functionName>: <key2> <value>');]],
				{ key1 = i(1), ["key2"] = rep(1), functionName = i(2), value = i(3, "not set") }
			),
		})
	),
})
